                ...
                <div className="relative z-10 flex flex-col justify-between p-12 text-white h-full w-full">
                    ...
                    <div className="mb-12">
                        <h2 className="text-4xl font-bold mb-6 leading-tight">
                            Professional Service <br /> Management Simplified.
                        </h2>
                        <p className="text-green-50 text-lg max-w-md leading-relaxed opacity-90">
                            Streamline your workflow, manage clients
                            efficiently, and grow your business with our
                            comprehensive expert platform.
                        </p>
                    </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <input
                                    ...
                                    name="remember-me"
                                    type="checkbox"
                                    className="h-4 w-4 text-[#4CAF50] focus:ring-[#4CAF50] border-gray-300 rounded cursor-pointer"
                                />
                                <label
                                    htmlFor="remember-me"
                            ...
                            <Link
                                ...
                                className="text-sm font-medium text-[#4CAF50] hover:text-[#45a049] transition-colors focus:outline-none hover:underline"
                            >
                                Forgot Password?
                            </Link>
                        </div>
